        ...
        <div class="mt-14 p-4  border-gray-200 border-dashed rounded-lg dark:border-gray-700 md:mt-14">
            <div class="grid grid-cols-0 gap-4 mb-4">
                <div
                    ...
                    <div class="justify-start py-2">
                        <form action="{{ route('carik.klinik') }}" method="GET" class="flex items-center">
                            @csrf
                            ...
                            <div class="relative w-full">
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        ...
                                        <path d="M12 9V5M14 7H10" stroke="#CED4DA" stroke-width="1.5" stroke-linecap="round"
                                ...
                                <input type="text" name="search"
                                    ...
                                    placeholder="Cari nama klinik" value="{{ request('search') }}" />
                            </div>
                            <button type="submit"
