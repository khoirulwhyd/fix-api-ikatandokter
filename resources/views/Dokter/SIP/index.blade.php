                                    ...
                                    <div class="flex justify-start items-center">
                                        <div class="justify-start">
                                            <p class="text-base justify-center font-bold text-gray-800 md:text-lg">
                                                Data SIP {{ $loop->iteration }}
                                            </p>
                                            <p
                                                class="px-2 mt-2 py-1 text-sm text-white font-semibold rounded-lg bg-green-500">
                                                Status : Aktif</p>
                                        </div>
                                    </div>
                                        ...
                                        <div>
                                            <form action="{{ route('data-sip.destroy', $sip->id) }}" method="post">
                                                ...
                                                <button type="submit" id="delete"
                                                    class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 show_confirm"
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="11" height="13"
                                                        ...
                                                        <path d="M10.4473 3.02144H0.570312" stroke="white"
                                                            stroke-width="1.04839" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path
                                    ...
                                    <tbody>
                                        <div>
                                            <tr class="bg-white border-b">
                                                ...
                                                <td class="px-6 py-4">{{ $sip->no_sip }}</td>
                                            </tr>
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                ...
                                                <td class="px-6 py-4">{{ $sip->nama_sarana }}</td>
                                            </tr>
                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                <th scope="row"
                                                    class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                ...
                                                <td class="px-6 py-4">{{ $sip->hari_pelayanan }}</td>
                                            </tr>
                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                <th scope="row"
                                                    class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                ...
                                                <td class="px-6 py-4">{{ $sip->waktu_pelayanan }}</td>
                                            </tr>
                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                <th scope="row"
                                                    class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                ...
                                                <td class="px-6 py-4">{{ $sip->provinsi }}</td>
                                            </tr>
                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                <th scope="row"
                                                    class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                ...
                                                <td class="px-6 py-4">{{ $sip->kab_kota }}</td>
                                            </tr>
                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                <th scope="row"
                                                    class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                ...
                                                <td class="px-6 py-4">{{ $sip->kelurahan }}</td>
                                            </tr>
                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                <th scope="row"
                                                    class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                ...
                                                <td class="px-6 py-4">RT. {{ $sip->rt }} / RW. {{ $sip->rw }}
                                                </td>
                                            </tr>
                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                <th scope="row"
                                                ...
                                                <td class="px-6 py-4">{{ $sip->kode_pos }}</td>
                                            </tr>
                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                <th scope="row"
                                                    class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                ...
                                                <td class="px-6 py-4">{{ $sip->alamat_lengkap }}</td>
                                            </tr>
                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                <th scope="row"
                                                    class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                ...
                                                <td class="px-6 py-4">{{ $sip->mulai_berlaku }}</td>
                                            </tr>
                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                <th scope="row"
                                                    class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                ...
                                                <td class="px-6 py-4">{{ $sip->akhir_berlaku }}</td>
                                            </tr>
                                            <tr class="bg-white border-b dark:bg-gray-800">
                                                <th scope="row"
                                                    class="py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                ...
                                <tr>
                                    <td class="text-center text-mute" colspan="8">
                                        <div class="mx-auto max-w-sm justify-center mt-10">
                                            <img class="w-full" src="/Assets/emptystate.png"
                                                class="justify-center items-center" alt="user photo" />
                                            <div class="py-4 text-center">
                                                <p class="text-center font-medium text-lg">Ups <strong
                                                        class="text-primary-600">Data SIPmu </strong> masih kosong.
                                                </p>
                                                <button type="button"
                                                    ...
                                                    onclick="location.href='{{ route('data-sip.create') }}'">
