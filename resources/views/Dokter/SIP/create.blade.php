...
@section('content')
    <div class="p-4 sm:ml-64">
        <div class="mt-14 p-4  border-gray-200 border-dashed rounded-lg dark:border-gray-700 md:mt-14">
            <form action="{{ route('data-sip.store') }}" method="POST">
                @csrf
                            ...
                            <div class="mx-auto justify-start">
                                <div class="mt-4 py-2">
                                    ...
                                    <input
                                        ...
                                        type="number" placeholder="Masukkan No STR" name="no_sip" required />
                                </div>
                                <div class="py-4">
                                    ...
                                    <input
                                        ...
                                        id="file_input" type="file" name="scan_sip" required />
                                </div>
                            </div>
                        </div>
                    </div>
