                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="flex justify-start ...">
                            ...
                            <div class="section-avatar px-6">
                                <p class="text-primary-600 text-base font-semibold md:text-xl">Dr. Lissa Nur Aini. S.T., M.T
                                </p>
                                ...
                                <form class="w-full max-w-lg mt-6">
                                        ...
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    <input
                                                        class="text-sm appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                        id="grid-last-name" type="number" name="noidentitas"
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                class="text-sm appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                id="grid-last-name" type="text" name="namalengkap"
                                        ...
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                <div class="w-full md:">
                                                    <input
                                                        class="text-sm appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                        id="grid-last-name" type="text" name="tempat"
                                                        placeholder="Tempat" />
                                                </div>
                                                <div>
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                <div
                                                    class="w-full flex items-center pl-6 border border-gray-200 rounded dark:border-gray-700">
                                                    <input id="bordered-radio-1" type="radio" value=""
                                                        name="laki-laki"
                                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                                    <label for="bordered-radio-1"
                                                        class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Laki-Laki</label>
                                                </div>
                                                <div
                                                    class="w-full flex items-center pl-6 border border-gray-200 rounded dark:border-gray-700">
                                                    <input id="bordered-radio-1" type="radio" value=""
                                                        ...
                                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                                                    <label for="bordered-radio-1"
                                                        class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Perempuan</label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                class="text-sm appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                id="grid-last-name" type="text" name="namapasangan"
                                ...
                                <form class="w-full max-w-lg mt-6">
                                        ...
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <div class="w-full">
                                                <div class="w-full">
                                                    <select
                                                        class="text-sm appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                        id="kab/kota" type="text" name="pilihkabupatenkota"
                                                        placeholder="">
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                ...
                                                name="kodepos" id="grid-last-name" type="number"
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <textarea id="message" name="alamatlengkap" rows="4"
                                ...
                                <form class="w-full max-w-lg mt-6">
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                class="text-sm appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                id="grid-last-name" name="notelponrumah" type="number"
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                class="text-sm appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                id="grid-last-name" name="nohp1" type="number"
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                class="text-sm appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                id="grid-last-name" name="nohp2" type="number"
                                                placeholder="Masukkan No Hp" />
                                        </div>
                                    </div>
                                </form>
