    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-gray-200 border-dashed rounded-lg dark:border-gray-700 md:mt-14">
            <div class="grid grid-cols-0 gap-4 mb-4">
                <form action="{{ route('data-pribadi.update', $dataPribadi->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2">
                            <div class="flex justify-start ...">
                                ...
                                <div class="section-avatar px-6">
                                    ...
                                    <p class="font-regular text-gray-400 text-sm sm:text-lg">{{ $dataPribadi->identitas }} -
                                        {{ $dataPribadi->no_identitas }}</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                ...
                                                placeholder="Masukkkan NPA IDI" value="{{ $dataPribadi->npaidi }}"
                                                required />
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                            ...
                                            <div class="grid grid-cols-2 gap-4">
                                                <div class="w-full">
                                                    <select name="identitas"
                                                        class="text-sm appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded-lg py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                                        id="grid-last-name" type="number" placeholder="Masukkkan NPA IDI">
                                                        <option selected value="{{ $dataPribadi->identitas }}">
                                                            {{ $dataPribadi->identitas }}</option>
                                                ...
                                                <div>
                                                    <input
                                                        ...
                                                        value="{{ $dataPribadi->no_identitas }}" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                ...
                                                value="{{ $dataPribadi->nama_lengkap }}" required />
                                        </div>
                                    </div>
                                    <div class="mb-6">
                                        <label for="upload"
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                <div class="w-full md:">
                                                    <input
                                                        ...
                                                        placeholder="Tempat" value="{{ $dataPribadi->tempat_lahir }}"
                                                        required />
                                                </div>
                                                <div>
                                                    <div class="relative max-w-sm">
                                                        ...
                                                        <input datepicker datepicker-autohide type="text"
                                                            ...
                                                            value="{{ date('m/d/Y', strtotime($dataPribadi->tanggal_lahir)) }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="w-full">
                                                <div class="w-full">
                                                    <select
                                                        ...
                                                        <option selected value="{{ $dataPribadi->kewarganegaraan }}">
                                                            {{ $dataPribadi->kewarganegaraan }}</option>
                                            ...
                                            <div className="w-full">
                                                <div class="w-full">
                                                    <select
                                                        ...
                                                        placeholder="Agama">
                                                        <option selected value="{{ $dataPribadi->agama }}">
                                                            {{ $dataPribadi->agama }}</option>
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                ...
                                                value="{{ $dataPribadi->nama_pasangan }}" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div className="w-full">
                                                <div class="w-full">
                                                    <select
                                                        ...
                                                        <option selected value="{{ $dataPribadi->ktp_provinsi }}">
                                                            {{ $dataPribadi->ktp_provinsi }}</option>
                                            ...
                                            <div class="w-full">
                                                <div class="w-full">
                                                    <select
                                                        ...
                                                        placeholder="">
                                                        <option selected value="{{ $dataPribadi->ktp_kabupaten_kota }}">
                                                            {{ $dataPribadi->ktp_kabupaten_kota }}</option>
                                            ...
                                            <div class="w-full">
                                                <div class="w-full">
                                                    <select
                                                        ...
                                                        placeholder="Kewarganegaraan">
                                                        <option selected value="{{ $dataPribadi->ktp_kecamatan }}">
                                                            {{ $dataPribadi->ktp_kecamatan }}</option>
                                            ...
                                            <div class="w-full">
                                                <div class="w-full">
                                                    <select
                                                        ...
                                                        <option selected value="{{ $dataPribadi->ktp_kelurahan }}">
                                                            {{ $dataPribadi->ktp_kelurahan }}</option>
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                <div class="w-full md:">
                                                    <input
                                                        ...
                                                        placeholder="Masukkan RT" value="{{ $dataPribadi->ktp_rt }}"
                                                        required />
                                                </div>
                                                <div>
                                                    <input
                                                        ...
                                                        placeholder="Masukkan RW" value="{{ $dataPribadi->ktp_rw }}"
                                                        required />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                ...
                                                placeholder="Masukkan kode pos" value="{{ $dataPribadi->ktp_kodepos }}"
                                                required />
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <textarea id="message" name="ktp_alamat_lengkap" rows="4"
                                                ...
                                                placeholder="Masukkan alamat lengkap disini">{{ $dataPribadi->ktp_alamat_lengkap }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                ...
                                                value="{{ $dataPribadi->no_teleponrumah }}" />
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                ...
                                                placeholder="Masukkan No Hp" value="{{ $dataPribadi->no_hp }}"
                                                required />
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                ...
                                                placeholder="Masukkan No Hp" value="{{ $dataPribadi->no_hp2 }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div className="w-full">
                                                <div class="w-full">
                                                    <select
                                                        ...
                                                        placeholder="Pilih Provinsi">
                                                        <option selected value="{{ $dataPribadi->krsp_provinsi }}">
                                                            {{ $dataPribadi->krsp_provinsi }}</option>
                                                        <option value="JawaTimur">Jawa Timur</option>
                                                        <option value="JawaTengah">Jawa Tengah</option>
                                                        <option value="JawaBarat">Jawa Barat</option>
                                                    </select>
                                            ...
                                            <div class="w-full">
                                                <div class="w-full">
                                                    <select
                                                        ...
                                                        placeholder="">
                                                        <option selected value="{{ $dataPribadi->krsp_kabupaten_kota }}">
                                                            {{ $dataPribadi->krsp_kabupaten_kota }}</option>
                                                        <option value="Kab. Malang">Kab. Malang</option>
                                                        <option value="Kota Malang">Kota Malang</option>
                                                        <option value="Bandung">Bandung</option>
                                                        <option value="Medan">Medan</option>
                                            ...
                                            <div class="w-full">
                                                <div class="w-full">
                                                    <select
                                                        ...
                                                        placeholder="Kewarganegaraan">
                                                        <option selected value="{{ $dataPribadi->krsp_kecamatan }}">
                                                            {{ $dataPribadi->krsp_kecamatan }}</option>
                                                        <option value="Kec. Lowokwaru">Kec. Lowokwaru</option>
                                                        <option value="Kec. Lowokwaru">Kec. Lowokwaru</option>
                                                        <option value="Kec. Sukun">Kec. Sukun</option>
                                                        <option value="Kec. Turen">Kec. Turen</option>
                                            ...
                                            <div class="w-full">
                                                <div class="w-full">
                                                    <select
                                                        ...
                                                        placeholder="kelurahan">
                                                        <option selected value="{{ $dataPribadi->krsp_kelurahan }}">
                                                            {{ $dataPribadi->krsp_kelurahan }}</option>
                                                        <option value="jatimulyo">Kelurahan Jatimulyo</option>
                                                        <option value="jatimulyo">Kelurahan Jatimulyo</option>
                                                        <option value="jatimulyo">Kelurahan Jatimulyo</option>
                                                        <option value="jatimulyo">Kelurahan Jatimulyo</option>
                                            ...
                                            <div class="grid grid-cols-2 gap-2">
                                                <div class="w-full md:">
                                                    <input
                                                        ...
                                                        placeholder="Masukkan RT" value="{{ $dataPribadi->krsp_rt }}"
                                                        required />
                                                </div>
                                                <div>
                                                    <input
                                                        ...
                                                        placeholder="Masukkan RW" value="{{ $dataPribadi->krsp_rw }}"
                                                        required />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <input
                                                ...
                                                placeholder="Masukkan kode pos" value="{{ $dataPribadi->krsp_kodepos }}"
                                                required />
                                        </div>
                                    </div>
                                    <div class="flex flex-wrap -mx-3 mb-6">
                                        <div class="w-full md:w-full px-3 mb-6 md:mb-0">
                                            ...
                                            <textarea id="message" name="krsp_alamat_lengkap" rows="4"
                                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Masukkan alamat lengkap disini">{{ $dataPribadi->krsp_alamat_lengkap }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
