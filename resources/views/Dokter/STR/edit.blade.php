    ...
    <div class="p-4 sm:ml-64">
        <div class="mt-14 p-4  border-gray-200 border-dashed rounded-lg dark:border-gray-700 md:mt-14">
            <div class="grid grid-cols-0 gap-4 mb-4">
                <form action="{{ route('data-str.update', $dataSTR->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div
                            ...
                            <div class="mx-auto justify-start">
                                <div class="mt-4 py-2">
                                    ...
                                    <input
                                        ...
                                        type="number" placeholder="Masukkan No STR" name="no_str"
                                        value="{{ $dataSTR->no_str }}" required />
                                </div>
                                <div class="py-4">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                        Scan STR
                                    ...
                                    <input
                                        ...
                                        id="file_input" type="file" name="scan_str" required />
                                </div>
                            </div>
                        </div>
                    </div>
